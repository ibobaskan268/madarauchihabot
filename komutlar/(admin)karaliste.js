...
let id = "683707976468398227" //Buraya kendi idni gir!
let user = message.mentions.users.first() || client.users.cache.get(args.slice(1).join(' '))
if(message.author.id !== "683707976468398227") return message.channel.send("<:carpitik:831644035637575741> Bu Komutu Sadece \`Kakashi.dll\` Kullanabilir");
